    ...
    >
      ...
      >
        ...
        <div className="flex flex-col space-y-2 mt-5 md:space-y-0 md:flex-row md:justify-between md:absolute md:bottom-[50px] md:left-[50px] md:right-[50px]">
          <button
            className="bg-[#DCC131] rounded-[20px] w-[121.2px] h-[23.61px] text-[11.04px] md:bg-[#DCC131] md:w-[220px] md:h-[53.44px] text-black text-xs md:text-[24px] py-1 px-3 md:px-6 md:py-3 md:rounded-[40px] md:ml-8"
          ...
          <button
            className="bg-[#DCC131] rounded-[20px] w-[121.2px] h-[23.61px] text-[11.04px] md:bg-[#DCC131] md:w-[220px] md:h-[53.44px] text-black text-xs md:text-[24px] py-1 px-3 md:px-6 md:py-3 md:rounded-[40px]"
